...
use App\Http\Controllers\ReportOperatorController;
...
use App\Http\Controllers\ReportWorkOrderController;
...
Route::middleware('auth')->group(function () {
  ...
  Route::get('/work-orders/{id}/edit-progress', [WorkOrderController::class, 'editProgress'])->name('work-orders.edit-progress');
  Route::post('/work-orders/{id}/progress', [WorkOrderController::class, 'updateProgress'])->name('work-orders.update-progress');
  Route::resource('work-orders', WorkOrderController::class);

  Route::prefix('reports')->name('reports.')->group(function () {
    Route::get('/work-orders', [ReportWorkOrderController::class, 'index'])->name('work-orders');
    Route::get('/work-orders/data', [ReportWorkOrderController::class, 'data'])->name('work-orders.data');
    Route::get('/work-orders/export', [ReportWorkOrderController::class, 'export'])->name('work-orders.export');

    Route::get('/operators', [ReportOperatorController::class, 'index'])->name('operators');
    Route::get('/operators/data', [ReportOperatorController::class, 'data'])->name('operators.data');
    Route::get('/operators/export', [ReportOperatorController::class, 'export'])->name('operators.export');
  });
});
