...
$(function () {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $role = full['role'];
            if ($role == 'super admin') {
              return `<span class="text-truncate d-flex align-items-center text-heading"><i class="ti ti-crown ti-md text-primary me-2"></i>Super Admin</span>`;
            } else if ($role == 'production manager') {
              return `<span class="text-truncate d-flex align-items-center text-heading"><i class="ti ti-edit ti-md text-warning me-2"></i>Production Manager</span>`;
            } else {
              return `<span class="text-truncate d-flex align-items-center text-heading"><i class="ti ti-user ti-md text-success me-2"></i>Operator</span>`;
            }
          }
        },
        {
  ...
  $(document).on('click', '.edit-record', function () {
    var user_id = $(this).data('id'),
      dtrModal = $('.dtr-bs-modal.show');
    $('#addNewUserForm').attr('action', `${baseUrl}users/${user_id}`);
    $('#addNewUserForm').attr('method', 'PUT');
  ...
  $('.add-new').on('click', function () {
    $('#addNewUserForm').attr('action', `${baseUrl}users`);
    $('#addNewUserForm').attr('method', 'POST');
    $('#offcanvasAddUserLabel').html('Add User');

    // Enable password validation when adding new user
